...
/* modernised - async handler, template literal SQL, scoring inlined */
...
function computeRiskScore(row) {
	...
	/* vendor country */
	const countryPoints = { US: 2, GB: 3, DE: 3, SG: 7, MX: 11 };
	score += countryPoints[row.country] !== undefined ? countryPoints[row.country] : 8;
	...
	/* hold reason overlay */
	const reasonPoints = { H21: 12, H07: 9, H41: 7, H09: 5 };
	score += reasonPoints[row.reason_code] || 0;
